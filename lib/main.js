...
function Uniform() {
	...
	if ( arguments.length ) {
		...
		if ( !isNumber( a ) || isnan( a ) ) {
			throw new TypeError( format( '19D8a,H5', a ) );
		}
		if ( !isNumber( b ) || isnan( b ) ) {
			throw new TypeError( format( '19D8b,H6', b ) );
		}
		if ( a >= b ) {
			throw new RangeError( format( '19DH7', a, b ) );
		}
	} else {
		a = 0.0;
		b = 1.0;
	...
	defineProperty( this, 'a', {
		...
		'set': function set( value ) {
			if ( !isNumber( value ) || isnan( value ) ) {
				throw new TypeError( format( '19D8d,H8', value ) );
			}
			if ( value >= b ) {
				throw new RangeError( format( '19D8e,H9', b, value ) );
			}
			a = value;
		}
	});
	defineProperty( this, 'b', {
		...
		'set': function set( value ) {
			...
			if ( a >= value ) {
				throw new RangeError( format( '19D8f,HA', a, value ) );
			}
			b = value;
		}
	});
