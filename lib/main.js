...
function Uniform() {
	...
	if ( arguments.length ) {
		...
		if ( !isNumber( a ) || isnan( a ) ) {
			throw new TypeError( format( '19D8a', a ) );
		}
		if ( !isNumber( b ) || isnan( b ) ) {
			throw new TypeError( format( '19D8b', b ) );
		}
		if ( a >= b ) {
			throw new RangeError( format( '19DDV', a, b ) );
		}
	} else {
		a = 0.0;
		b = 1.0;
	...
	defineProperty( this, 'a', {
		...
		'set': function set( value ) {
			if ( !isNumber( value ) || isnan( value ) ) {
				throw new TypeError( format( '19D8d', value ) );
			}
			if ( value >= b ) {
				throw new RangeError( format( '19D8e', b, value ) );
			}
			a = value;
		}
	});
	defineProperty( this, 'b', {
		...
		'set': function set( value ) {
			...
			if ( a >= value ) {
				throw new RangeError( format( '19D8f', a, value ) );
			}
			b = value;
		}
	});
